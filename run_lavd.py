...
from lavd.dcrf3 import DeepCRFModel
...
print("load dataset...")
label_dataset = LAVDDataset(config.train_set, config.dev_set, config.test_set, batch_size=config.batch_size,
                            fold=config.labeled_range, shuffle=True)
partial_dataset = LAVDDataset(config.train_set_p, None, None, batch_size=config.batch_size, fold=config.partial_range,
                              shuffle=True)
unlabeled_dataset = LAVDDataset(config.train_set_u, None, None, batch_size=config.batch_size, fold=config.unlabeled_range,
                                shuffle=True)
